...
namespace PizzeriaApi.Migrations
{
    ...
    [Migration("20240331145432_OrderQtdColumn")]
    partial class OrderQtdColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 463, DateTimeKind.Utc).AddTicks(2586))
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 463, DateTimeKind.Utc).AddTicks(2947))
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 467, DateTimeKind.Utc).AddTicks(7280))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 467, DateTimeKind.Utc).AddTicks(7704))
                        .HasColumnName("UpdatedAt");
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Payament", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 467, DateTimeKind.Utc).AddTicks(4800))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 467, DateTimeKind.Utc).AddTicks(5311))
                        .HasColumnName("UpdatedAt");
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Pizza", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 463, DateTimeKind.Utc).AddTicks(1093))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 463, DateTimeKind.Utc).AddTicks(1476))
                        .HasColumnName("UpdatedAt");
            ...
            modelBuilder.Entity("PizzeriaApi.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 462, DateTimeKind.Utc).AddTicks(1234))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 54, 32, 462, DateTimeKind.Utc).AddTicks(1754))
                        .HasColumnName("UpdatedAt");
