...
namespace PizzeriaApi.Migrations
{
    ...
    [Migration("20240330225108_UpdateCartRelationToCartItem")]
    partial class UpdateCartRelationToCartItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 286, DateTimeKind.Utc).AddTicks(6684))
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 286, DateTimeKind.Utc).AddTicks(7052))
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 291, DateTimeKind.Utc).AddTicks(192))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 291, DateTimeKind.Utc).AddTicks(651))
                        .HasColumnName("UpdatedAt");
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Payament", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 290, DateTimeKind.Utc).AddTicks(8357))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 290, DateTimeKind.Utc).AddTicks(8855))
                        .HasColumnName("UpdatedAt");
            ...
            modelBuilder.Entity("PizzeriaApi.Models.Pizza", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 286, DateTimeKind.Utc).AddTicks(5137))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 286, DateTimeKind.Utc).AddTicks(5581))
                        .HasColumnName("UpdatedAt");
            ...
            modelBuilder.Entity("PizzeriaApi.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 285, DateTimeKind.Utc).AddTicks(4772))
                        .HasColumnName("CreatedAt");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2024, 3, 30, 22, 51, 8, 285, DateTimeKind.Utc).AddTicks(5234))
                        .HasColumnName("UpdatedAt");
